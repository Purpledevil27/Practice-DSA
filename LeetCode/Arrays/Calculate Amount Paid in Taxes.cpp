...
an upper bound of upperi and is taxed at a rate of percenti. The brackets are sorted by upper bound
...
And so on.
You are given an integer income representing the amount of money you earned. Return the amount of money that you have to pay in
...
public:
    double calculateTax(vector<vector<int>> &brackets, int income)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            tax += max(0.0, ((min(income, brackets[i][0]) - prev) * (brackets[i][1])) / 100);
            prev = brackets[i][0];
